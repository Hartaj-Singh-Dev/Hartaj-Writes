  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="bg-[#0e2640] px-3 w-full flex flex-col justify-center items-center text-slate-400 font-bold leading-[3.4rem] sm:leading-[4.2rem] md:leading-[5.2rem] lg:leading-[6.2rem] xl:leading-[7.4rem] font-['Unbounded'] tracking-tight  text-3xl  xl:text-[5.2rem] sm:text-[3.7rem] lg:text-[4.7rem]  h-[55vh] sm:h-[90vh]">
